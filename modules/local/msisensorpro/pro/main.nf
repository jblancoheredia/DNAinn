process MSISENSORPRO {
    ...
    tuple val(meta), path("${meta.id}.msi_uns"), emit: msi_uns
    tuple val(meta), path("${meta.id}.msi_dis"), emit: msi_dis
    tuple val(meta), path("${meta.id}.msi_all"), emit: msi_all
    ...
    mv ${prefix}            ${prefix}.summary
    mv ${prefix}_unstable   ${prefix}.msi_uns
    mv ${prefix}_dis        ${prefix}.msi_dis
    mv ${prefix}_all        ${prefix}.msi_all
    ...
    touch ${prefix}.msi_uns
    touch ${prefix}.msi_dis
    touch ${prefix}.msi_all
...
process MSISENSORPRO_DR {
    ...
    output:
    tuple val(meta), path("${meta.id}.summary.dr"), emit: summary
    tuple val(meta), path("${meta.id}.msi_uns.dr"), emit: msi_uns
    tuple val(meta), path("${meta.id}.msi_dis.dr"), emit: msi_dis
    tuple val(meta), path("${meta.id}.msi_all.dr"), emit: msi_all
    path "versions.yml",                         emit: versions
    ...
    mv ${prefix}            ${prefix}.summary.dr
    mv ${prefix}_unstable   ${prefix}.msi_uns.dr
    mv ${prefix}_dis        ${prefix}.msi_dis.dr
    mv ${prefix}_all        ${prefix}.msi_all.dr
    ...
    def prefix = task.ext.prefix ?: "${meta.id}"
    """
    touch ${prefix}.summary.dr
    touch ${prefix}.msi_uns.dr
    touch ${prefix}.msi_dis.dr
    touch ${prefix}.msi_all.dr
